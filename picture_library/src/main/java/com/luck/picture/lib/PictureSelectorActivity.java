...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    public void startOpenCamera() {
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            File cameraFile = PictureFileUtils.createCameraFile(this, mimeType == PictureConfig.TYPE_ALL ? PictureConfig.TYPE_IMAGE : mimeType, outputCameraPath);
    ...
    private Uri parUri(File cameraFile) {
        ...
        Log.e("PictureSelectorActivity",authority);
